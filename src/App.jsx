...
function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-neutral-800 flex flex-col items-center justify-center text-center">
      <div className="flex items-center justify-center spcae-x-8 mb-12">
      ...
      <h1 className="text-white text-8xl mb-16">Vite + React</h1>
      <h3 className="text-lg font-bold text-white">Tsaqif Akmal</h3>
      ...
      <p className="read-the-docs text-neutral-800">
